...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $connection->prepare("INSERT INTO instructors(instructor_id, user_id, bio,expertise) VALUES (?, ?, ?,?)");
    $stmt->bind_param("isss", $instructor_id, $UserID, $bio,$expertise);
    // Set parameters and execute
    $instructor_id = $_POST['book_id'];
    $UserID = $_POST['ride_id'];
    $bio = $_POST['passenger_id'];
    $expertise = $_POST['passengerid'];

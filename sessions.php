...
<form method="post" onsubmit="return confirmInsert();">
    ...
    <label for="session_topic">session_topic:</label>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $connection->prepare("INSERT INTO sessions(session_id, workshop_id, session_date,start_time,end_time,session_topic) VALUES (?, ?, ?,?,?,?)");
    $stmt->bind_param("isssss", $session_id, $workshop_id, $session_date,$start_time,$end_time,$session_topic);
    // Set parameters and execute
    $session_id = $_POST['book_id'];
    $workshop_id = $_POST['ride_id'];
    $session_date = $_POST['passenger_id'];
    $start_time = $_POST['passengerid'];
    $end_time = $_POST['passengeid'];
    $session_topic = $_POST['passengid'];

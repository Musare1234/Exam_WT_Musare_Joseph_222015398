...
<form method="post" onsubmit="return confirmInsert();">
    ...
    <input type="date" id="passengid" name="passengid" required><br><br>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $connection->prepare("INSERT INTO workshops(workshop_id, title, description,start_date,end_date,instructor_id) VALUES (?, ?, ?,?,?,?)");
    
    $stmt->bind_param("issss", $workshop_id, $title, $description,$start_date,$end_date,$instructor_id);
    // Set parameters and execute
    $workshop_id = $_POST['book_id'];
    $title = $_POST['ride_id'];
    $description = $_POST['passenger_id'];
    $start_date = $_POST['passengeid'];
    $end_date = $_POST['passengid'];
    $instructor_id = $_POST['passengd'];
